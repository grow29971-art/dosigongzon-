...
export const SPECIAL_SKILLS: Record<SpecialSkillId, SpecialSkill> = {
  ...
  grooming:      { id:"grooming",      name:"그루밍",         desc:"HP 16% 회복",           icon:"🧼", rarity:"common" },
  warm_nap:      { id:"warm_nap",      name:"따뜻한 낮잠",    desc:"HP 14% 회복",            icon:"😴", rarity:"common" },
  ...
  bind:          { id:"bind",          name:"속박",     desc:"타격 + 75% 확률 3턴 속박(회피불가)", icon:"⛓️", rarity:"rare" },
  ...
  howl:          { id:"howl",          name:"하울링",   desc:"타격 + 75% 확률 3턴 속박(회피불가)", icon:"🐺", rarity:"rare" },
  ...
  shockwave:     { id:"shockwave",     name:"충격파",   desc:"강타 (1.6×)",                icon:"💥", rarity:"rare" },
  // 레전드
  vampirism:  { id:"vampirism",  name:"흡혈",  desc:"가한 피해 45% 흡수",            icon:"🧛", rarity:"legendary" },
  ...
  regen:      { id:"regen",      name:"재생",  desc:"HP 34% 회복", icon:"💚", rarity:"legendary" },
  ...
  cleanse:    { id:"cleanse",    name:"정화",  desc:"상태이상 해제 + HP 32% 회복",   icon:"💫", rarity:"legendary" },
  judgment:        { id:"judgment",        name:"천벌",     desc:"강타(1.05×) + 50% 확률 2턴 속박+기절", icon:"⚡", rarity:"legendary" },
  apocalypse_strike: { id:"apocalypse_strike", name:"종말의 일격", desc:"필살 강타 (2.05×)", icon:"🌋", rarity:"legendary" },
};
