...
// 카드 화면의 "기술" 이름으로 쓰이는 속성풍 스킬명 (2026-07-06 성격 단어 → 고양이 속성 스킬명으로 전면 교체)
export const TRAITS = ["화염 발톱","빙결 숨결","전격 질주","맹독 이빨","그림자 도약","폭풍 발톱","대지 강타","달빛 베기","섬광 일격","회오리 발차기","용암 발톱","서리 발톱","벼락 발톱","암흑 강타","신성한 발톱","폭염 숨결","빙하 강타","질풍 베기","맹화 발톱","심연 강타","뇌전 일격","폭풍우 발톱","유성 낙하","여명의 발톱","혹한 강타"];
