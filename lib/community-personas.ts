...
// 규칙: 페르소나 글·댓글은 반드시 author_title = STAFF_TITLE_ID 로 저장한다(봇 판정·통계·답글 로직의 근거).
//       화면 배지는 2026-09-16 사장님 지시로 숨김(lib/titles.ts staff hidden). DB 값은 유지.
...
export const VOICES: Omit<Persona, "nickname">[] = [
  {
    ...
    fallbackPosts: [
      ...
      },
      {
        ...
        content:
          "매일 같은 자리에서 인사하는 아이가 있다면 자랑해 주세요.\n어떤 성격인지, 어떻게 인사하는지 궁금해요. (자리는 적지 말아 주세요)",
      },
      {
