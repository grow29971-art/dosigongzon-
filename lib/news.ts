...
export const NEWS_ITEMS: NewsItem[] = [
  {
    ...
    image: "https://placehold.co/800x450/FFEDD5/F97316?text=CAT+FESTA+2026",
...
올해는 특별히 '길고양이와 도시 공존' 주제로 지자체 협력 사례를 공유하는 포럼이 마련됩니다. 전국의 캣맘, 캣대디분들과 함께 소통할 수 있는 소중한 기회입니다.`,
  ...
  },
  {
    ...
    image: "https://placehold.co/800x450/CCFBF1/14B8A6?text=TNR+Program",
...
• 수술 후 1~2일 안정 후 원래 장소에 방사해주세요`,
  ...
  },
  {
    ...
    image: "https://placehold.co/800x450/EDE9FE/8B5CF6?text=Animal+Protection+Law",
