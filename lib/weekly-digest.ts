...
<body style="margin:0;padding:0;background:#F7F4EE;font-family:-apple-system,BlinkMacSystemFont,'Apple SD Gothic Neo',sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:24px 16px;">
    ...
    <div style="background:#fff;border-radius:20px;padding:24px;margin-bottom:14px;box-shadow:0 4px 16px rgba(0,0,0,0.05);">
      <div style="font-size:11px;font-weight:800;color:#AD5E3B;letter-spacing:0.15em;">WEEKLY DIGEST</div>
      <div style="font-size:24px;font-weight:900;color:#2A2A28;margin-top:6px;letter-spacing:-0.02em;">
        ${displayName} 님, <br/>이번 주 <span style="color:#AD5E3B;">도시공존</span> 소식이에요
      </div>
      <div style="font-size:13px;color:#8B7562;margin-top:10px;line-height:1.6;">
        서울 전역에 <b style="color:#AD5E3B;">새 고양이 ${content.newCatsThisWeek}마리</b>가 등록됐고,
    ...
    <!-- CTA -->
    <div style="background:linear-gradient(135deg,#AD5E3B 0%,#A8684A 100%);border-radius:18px;padding:20px;text-align:center;margin-bottom:14px;">
      ...
      <a href="${SITE_URL}/map?utm_source=email&utm_medium=digest&utm_campaign=weekly"
         style="display:inline-block;background:#fff;color:#AD5E3B;font-size:13px;font-weight:800;padding:12px 24px;border-radius:999px;text-decoration:none;">
        지도 바로 열기 →
      </a>
    </div>
