...
export const ADMIN_TITLES: AdminTitle[] = [
  { id: "og_200", name: "초기 200", emoji: "🌟", color: "#E88D5A", description: "정식 출시 직전(2026-05-25 D-3) 도시공존에 합류한 처음 200명에게 영구 부여되는 한정 타이틀" },
  { id: "founding_member", name: "창립 멤버", emoji: "✨", color: "#C47E5A", description: "정식 오픈(2026-05-25) 전 도시공존을 함께 시작한 초기 멤버" },
