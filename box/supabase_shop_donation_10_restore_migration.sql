...
--
-- 결정 확정(2026-08-17): 10%로 상향한다.
-- ⚠ 후속 정합성: 2026-08-06 대주산업 제휴 공문에 "판매 수익의 5%를 TNR에 환원"으로
--    적었으므로(그래서 8/7에 5%로 맞췄음), 실제 환원율(10%)과 공문(5%)이 어긋난다.
--    소비자에게 불리하진 않으나(더 기부), 제휴사·정산 기준 정합을 위해 다음 접촉 때
--    공문/합의를 10% 기준으로 갱신할 것.
--
