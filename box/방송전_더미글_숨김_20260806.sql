...
-- 배포 불필요: 코드 변경 0, SQL만.
--
-- ⚠ 실행 시점 주의: 큰 유입 이벤트 24시간 이내에는 하지 말 것.
--    글이 빠지면서 내 동네 필터·HOT 게시글·프로필 활동 목록이 예상 밖으로 비어 보일 수
--    있다. 실행 후 최소 하루는 눈으로 확인할 시간을 두고 돌린다.
--
-- 2026-08-07: 〈궁금한 이야기 Y〉 출연은 무산됐다. 다만 이 조치는 방송과 무관하게 유효하다.
--    가짜 입양·임보 공고에 연락하는 건 기자가 아니라 평범한 이용자이고, 실제 건물명이
--    박힌 가짜 학대 제보는 지금도 그 자리에 있다. 급하지 않을 뿐 없어져야 할 문제다.
-- ══════════════════════════════════════════
