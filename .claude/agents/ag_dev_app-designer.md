...
- 톤: 테라코타 — primary #AD5E3B (light #C47E5A / dark #8A4325), 텍스트 #191F28.
  2026-07-21 확정, **WAU 100 도달까지 테마색 재논의 동결**. 새 화면은 반드시 토큰 변수로만 (색 하드코딩 금지).
- 색 일괄 치환이 필요해지면 revert 기준선 방식 필수 — 치환 직전 커밋을 기준선으로 남기고, 색 변경만 담긴 단독 커밋으로.
