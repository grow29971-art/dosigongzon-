...
export const metadata: Metadata = {
  ...
  description:
    "길고양이를 발견했을 때, 새끼고양이가 있을 때, TNR(중성화) 신청 방법, 임시보호·입양 절차, 학대 신고, 응급 처치, 길집사 활동까지. 시민이 가장 자주 묻는 30개 질문에 도시공존이 답해드려요.",
...
const CATEGORIES: FaqCategory[] = [
    ...
    items: [
      {
        q: "임시보호와 입양의 차이가 뭔가요?",
        answer:
          "임시보호는 입양 갈 곳을 찾는 동안 일정 기간(보통 2~8주) 우리 집에서 돌봐주는 거예요. 입양처가 나오면 보내야 합니다. 입양은 평생 가족으로 책임지는 것. 둘 다 동물보호단체나 개인 길집사를 통해 매칭됩니다.",
        answerHtml: (
          <>
            임시보호는 입양 갈 곳을 찾는 동안 일정 기간(보통 2~8주) 우리 집에서 돌봐주는 거예요. 입양처가 나오면 보내야 합니다. 입양은 평생 가족으로 책임지는 것. 둘 다 동물보호단체나 개인 길집사를 통해 매칭됩니다.{" "}
      ...
      },
      {
        ...
        answer:
          "동물보호관리시스템(animal.go.kr), 자치구 유기동물 보호소, 동물보호단체, 길집사 커뮤니티를 통해 입양 가능합니다. 도시공존에서도 곧 입양 매칭 기능이 들어올 예정이에요. 입양 전 임시보호로 한두 달 같이 살아보면 서로 적응하기 쉬워요.",
        answerHtml: (
          <>
            동물보호관리시스템(animal.go.kr), 자치구 유기동물 보호소, 동물보호단체, 길집사 커뮤니티를 통해 입양 가능합니다. 도시공존에서도 곧 입양 매칭 기능이 들어올 예정이에요. 입양 전 임시보호로 한두 달 같이 살아보면 서로 적응하기 쉬워요.
          </>
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "길집사 활동 중 비용 지원받을 수 있나요?",
        answer:
          "사료·치료비 지원 사업이 자치구·동물보호단체별로 운영됩니다. 동물자유연대·카라·동물권행동 KARA 등 단체에서 매년 사료 지원, TNR 의료비 지원 등을 진행해요. 자치구 동물보호 담당부서에도 길집사 등록 후 지원받을 수 있는 프로그램이 있어요.",
        answerHtml: (
          <>
            사료·치료비 지원 사업이 자치구·동물보호단체별로 운영됩니다. 동물자유연대·카라·동물권행동 KARA 등 단체에서 매년 사료 지원, TNR 의료비 지원 등을 진행해요. 자치구 동물보호 담당부서에도 길집사 등록 후 지원받을 수 있는 프로그램이 있으니{" "}
            <Link href="/protection/district-contacts" className="underline" style={{ color: "var(--color-primary-dark)" }}>
              담당부서 연락처
            </Link>
            를 확인하세요.
    ...
    items: [
      {
        q: "도시공존은 어떤 앱인가요?",
        answer:
          "도시공존은 우리 동네 길고양이를 지도에 기록하고, 이웃 길집사와 돌봄 정보를 나누는 시민 참여 플랫폼이에요. 고양이 등록·돌봄다이어리·이웃 쪽지·동물병원 정보·긴급 구조·뉴스를 한 곳에서. 무료이고, 회원가입 후 우리 동네 길고양이부터 등록해 보세요.",
        answerHtml: (
          <>
            도시공존은 우리 동네 길고양이를 지도에 기록하고, 이웃 길집사와 돌봄 정보를 나누는 시민 참여 플랫폼이에요. 고양이 등록·돌봄다이어리·이웃 쪽지·동물병원 정보·긴급 구조·뉴스를 한 곳에서. 무료이고, 회원가입 후 우리 동네 길고양이부터 등록해 보세요.{" "}
      ...
      },
      {
        ...
        answer:
          "아니요. 아이들의 안전을 위해 위치를 3중으로 보호해요. 첫째, 등록하는 순간 실제 좌표 대신 수백 미터 무작위로 이동된 좌표만 저장돼 운영자조차 실제 위치를 알 수 없어요. 둘째, 지도 마커는 실제 고양이처럼 자기 동네 안에서 계속 움직여서(쉬기·산책·우다다) 화면 위 위치가 실시간 위치가 아니에요. 셋째, 로그인하지 않은 방문자에게는 위치가 한층 더 넓게 퍼져 보여요. 그래서 지도를 지켜봐도 급식소나 아지트를 특정할 수 없습니다.",
        answerHtml: (
          <>
            아니요. 아이들의 안전을 위해 위치를 <b>3중으로 보호</b>해요. ① 등록하는 순간 실제 좌표 대신
            수백 미터 무작위로 이동된 좌표만 저장돼 운영자조차 실제 위치를 알 수 없어요. ② 지도 마커는
            실제 고양이처럼 자기 동네 안에서 계속 움직여서(쉬기 💤·산책 🐾·우다다 💨) 화면 위 위치가
            실시간 위치가 아니에요. ③ 로그인하지 않은 방문자에게는 위치가 한층 더 넓게 퍼져 보여요.
            그래서 지도를 지켜봐도 급식소나 아지트를 특정할 수 없습니다.
          </>
        ),
      },
      {
        q: "지도 속 고양이 마커가 움직이는데 실제로 이동 중인 건가요?",
        answer:
          "아니요, 위치 보호 장치예요. 마커의 움직임은 고양이 학대 시도를 막기 위해 일부러 넣은 기능으로, 실제 고양이의 움직임과는 무관해요. 다만 실제 고양이처럼 새벽·저녁에 활발하고 한낮에 쉬는 하루 리듬으로 움직여서, 지도가 살아있는 동네처럼 보이도록 만들었어요. 마커에 붙은 💤(쉬는 중)·🐾(산책 중)·💨(우다다) 이모지로 상태를 볼 수 있어요.",
        answerHtml: (
          <>
            아니요, <b>위치 보호 장치</b>예요. 마커의 움직임은 고양이 학대 시도를 막기 위해 일부러 넣은
            기능으로, 실제 고양이의 움직임과는 무관해요. 다만 실제 고양이처럼 새벽·저녁에 활발하고 한낮에
            쉬는 하루 리듬으로 움직여서, 지도가 살아있는 동네처럼 보이도록 만들었어요. 마커에 붙은 💤(쉬는
            중)·🐾(산책 중)·💨(우다다) 이모지로 상태를 볼 수 있어요.
          </>
        ),
      },
      {
    ...
    <>
      ...
      <main className="mx-auto w-full max-w-2xl px-4 pb-24 pt-3">
        ...
        <nav
          ...
          style={{ borderColor: "rgba(17, 17, 17,0.18)", background: "rgba(255,253,250,0.7)" }}
        >
          <p
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link
              ...
              style={{ borderColor: "rgba(17, 17, 17,0.3)", color: "var(--color-primary-dark)" }}
            >
              앱 사용 가이드
            </Link>
            <a
