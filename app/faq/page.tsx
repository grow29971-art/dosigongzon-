...
export const metadata: Metadata = {
  ...
  description:
    "길고양이를 발견했을 때, 새끼고양이가 있을 때, TNR(중성화) 신청 방법, 임시보호·입양 절차, 학대 신고, 응급 처치, 캣맘 활동까지. 시민이 가장 자주 묻는 30개 질문에 도시공존이 답해드려요.",
...
const CATEGORIES: FaqCategory[] = [
    ...
    items: [
      {
        q: "임시보호와 입양의 차이가 뭔가요?",
        answer:
          "임시보호는 입양 갈 곳을 찾는 동안 일정 기간(보통 2~8주) 우리 집에서 돌봐주는 거예요. 입양처가 나오면 보내야 합니다. 입양은 평생 가족으로 책임지는 것. 둘 다 동물보호단체나 개인 캣맘을 통해 매칭됩니다.",
        answerHtml: (
          <>
            임시보호는 입양 갈 곳을 찾는 동안 일정 기간(보통 2~8주) 우리 집에서 돌봐주는 거예요. 입양처가 나오면 보내야 합니다. 입양은 평생 가족으로 책임지는 것. 둘 다 동물보호단체나 개인 캣맘을 통해 매칭됩니다.{" "}
      ...
      },
      {
        ...
        answer:
          "동물보호관리시스템(animal.go.kr), 자치구 유기동물 보호소, 동물보호단체, 캣맘 커뮤니티를 통해 입양 가능합니다. 도시공존에서도 곧 입양 매칭 기능이 들어올 예정이에요. 입양 전 임시보호로 한두 달 같이 살아보면 서로 적응하기 쉬워요.",
        answerHtml: (
          <>
            동물보호관리시스템(animal.go.kr), 자치구 유기동물 보호소, 동물보호단체, 캣맘 커뮤니티를 통해 입양 가능합니다. 도시공존에서도 곧 입양 매칭 기능이 들어올 예정이에요. 입양 전 임시보호로 한두 달 같이 살아보면 서로 적응하기 쉬워요.
          </>
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "캣맘 활동 중 비용 지원받을 수 있나요?",
        answer:
          "사료·치료비 지원 사업이 자치구·동물보호단체별로 운영됩니다. 동물자유연대·카라·동물권행동 KARA 등 단체에서 매년 사료 지원, TNR 의료비 지원 등을 진행해요. 자치구 동물보호 담당부서에도 캣맘 등록 후 지원받을 수 있는 프로그램이 있어요.",
        answerHtml: (
          <>
            사료·치료비 지원 사업이 자치구·동물보호단체별로 운영됩니다. 동물자유연대·카라·동물권행동 KARA 등 단체에서 매년 사료 지원, TNR 의료비 지원 등을 진행해요. 자치구 동물보호 담당부서에도 캣맘 등록 후 지원받을 수 있는 프로그램이 있으니{" "}
            <Link href="/protection/district-contacts" className="underline" style={{ color: "#A8684A" }}>
              담당부서 연락처
            </Link>
            를 확인하세요.
    ...
    items: [
      {
        q: "도시공존은 어떤 앱인가요?",
        answer:
          "도시공존은 우리 동네 길고양이를 지도에 기록하고, 이웃 캣맘·캣대디와 돌봄 정보를 나누는 시민 참여 플랫폼이에요. 고양이 등록·돌봄 일지·이웃 쪽지·동물병원 정보·긴급 구조·뉴스를 한 곳에서. 무료이고, 회원가입 후 우리 동네 길고양이부터 등록해 보세요.",
        answerHtml: (
          <>
            도시공존은 우리 동네 길고양이를 지도에 기록하고, 이웃 캣맘·캣대디와 돌봄 정보를 나누는 시민 참여 플랫폼이에요. 고양이 등록·돌봄 일지·이웃 쪽지·동물병원 정보·긴급 구조·뉴스를 한 곳에서. 무료이고, 회원가입 후 우리 동네 길고양이부터 등록해 보세요.{" "}
