    ...
    items: [
      {
        ...
        answerHtml: (
          <>
            ...
            <Link href="/map" className="underline" style={{ color: "#8B6FE0" }}>
              도시공존 지도
            </Link>
      ...
      },
      {
        ...
        answerHtml: (
          <>
            ...
            <Link href="/protection/emergency-guide" className="underline" style={{ color: "#8B6FE0" }}>
              응급 처치 가이드
            </Link>
            에서 첫 30분 대응법을 확인하실 수 있고,{" "}
            <Link href="/hospitals" className="underline" style={{ color: "#8B6FE0" }}>
              구조동물 치료 병원
            </Link>{" "}
      ...
      },
      {
        ...
        answerHtml: (
          <>
            ...
            <Link href="/protection/legal" className="underline" style={{ color: "#8B6FE0" }}>
              동물보호법 정리
            </Link>{" "}
      ...
      },
      {
        ...
        answerHtml: (
          <>
            120(다산 콜센터) 또는 자치구 청소행정과에 신고하면 사체 처리해 줍니다. 사유지에서 발견한 경우 토지 소유자가 처리 책임이 있어요. 학대 의심 정황이 있으면 사진을 찍어 두고 경찰에 함께 신고하세요.{" "}
            <Link href="/protection/district-contacts" className="underline" style={{ color: "#8B6FE0" }}>
              시군구 담당부서 연락처
            </Link>
            를 한눈에 볼 수 있어요.
          </>
      ...
      },
      {
        ...
        answerHtml: (
          <>
            낮은 자세로 천천히 다가가세요. 정면으로 눈을 마주치지 말고 옆쪽에서, 손을 아래로 내밀어 냄새 먼저 맡게 합니다. 갑작스러운 소리·움직임은 금물이에요. 평소 같은 시간에 같은 장소에서 사료를 두면 신뢰가 빨리 쌓여요.{" "}
            <Link href="/protection/feeding-guide" className="underline" style={{ color: "#8B6FE0" }}>
              급식 가이드
            </Link>
            도 참고해 보세요.
          </>
    ...
    items: [
      {
        ...
        answerHtml: (
          <>
            ...
            <Link href="/protection/kitten-guide" className="underline" style={{ color: "#8B6FE0" }}>
              새끼고양이 발견 가이드
            </Link>
            를 봐주세요.
          </>
    ...
    items: [
      {
        ...
        answerHtml: (
          <>
            ...
            <Link href="/protection/trapping-guide" className="underline" style={{ color: "#8B6FE0" }}>
              TNR 요령 가이드
            </Link>
            에서 자세히 다뤘어요.
          </>
    ...
    items: [
      {
        ...
        answerHtml: (
          <>
            임시보호는 입양 갈 곳을 찾는 동안 일정 기간(보통 2~8주) 우리 집에서 돌봐주는 거예요. 입양처가 나오면 보내야 합니다. 입양은 평생 가족으로 책임지는 것. 둘 다 동물보호단체나 개인 케어테이커를 통해 매칭됩니다.{" "}
            <Link href="/protection/shelter-guide" className="underline" style={{ color: "#8B6FE0" }}>
              임시보호 시작 가이드
            </Link>
            를 참고하세요.
          </>
    ...
    items: [
      {
        ...
        answerHtml: (
          <>
            ...
            <Link href="/protection/disease-guide" className="underline" style={{ color: "#8B6FE0" }}>
              질병 가이드
            </Link>
            를 봐주세요.
          </>
      ...
      },
      {
        ...
        answerHtml: (
          <>
            ...
            <Link href="/protection/pharmacy-guide" className="underline" style={{ color: "#8B6FE0" }}>
              약품 가이드
            </Link>
    ...
    items: [
      ...
      },
      {
        ...
        answerHtml: (
          <>
            스티로폼 상자에 담요·짚을 깔고 입구를 작게 만든 겨울집이 가장 일반적이에요. 바닥에서 띄워 한기를 막고, 입구는 바람 방향과 반대쪽으로. 핫팩은 직접 접촉을 피하고 천으로 감싸 사용. 겨울집 위치는 사람 손이 잘 안 닿는 조용한 곳에 두세요.{" "}
            <Link href="/shelters" className="underline" style={{ color: "#8B6FE0" }}>
              우리 동네 쉼터 지도
            </Link>
            도 확인해 보세요.
          </>
    ...
    items: [
      {
        ...
        answerHtml: (
          <>
            도시공존은 우리 동네 길고양이를 지도에 기록하고, 이웃 케어테이커와 돌봄 정보를 나누는 시민 참여 플랫폼이에요. 고양이 등록·돌봄다이어리·이웃 쪽지·동물병원 정보·긴급 구조·뉴스를 한 곳에서. 무료이고, 회원가입 후 우리 동네 길고양이부터 등록해 보세요.{" "}
            <Link href="/guide" className="underline" style={{ color: "#8B6FE0" }}>
              사용 가이드
            </Link>
            를 보면 빠르게 익숙해질 수 있어요.
          </>
      ...
      },
      {
        ...
        answerHtml: (
          <>
            ...
            <Link href="/mypage" className="underline" style={{ color: "#8B6FE0" }}>
              마이페이지
            </Link>{" "}
            → 푸시 알림 설정에서 끌 수 있어요.
          </>
      ...
      },
      {
        ...
        answerHtml: (
          <>
            ...
            <Link href="/" className="underline" style={{ color: "#8B6FE0" }}>
              dosigongzon.com
            </Link>
                ...
                {c.items.map((it, idx) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <ChevronDown
                        size={18}
                        className="mt-0.5 shrink-0 text-[#8B6FE0] transition-transform group-open:rotate-180"
                      />
                    </summary>
                    <div
        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link
              ...
              style={{ borderColor: "rgba(92,141,238,0.3)", color: "#8B6FE0" }}
            >
              앱 사용 가이드
            </Link>
            <a
