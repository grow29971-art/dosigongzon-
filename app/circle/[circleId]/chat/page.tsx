      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1 mt-0.5">
            ...
            <span className="text-[11px] text-text-light">멤버 {memberCount + 1}명</span>
          </div>
        </div>
      </div>
                ...
                return (
                  <div key={m.id} className={`flex gap-2 mb-2.5 ${isMine ? "flex-row-reverse" : "flex-row"}`}>
                    ...
                    <div className={`max-w-[75%] ${isMine ? "items-end" : "items-start"} flex flex-col`}>
                      {!isMine && (
                        <p className="text-[11px] text-text-light mb-0.5 ml-1">
                          {m.sender_name ?? "익명"}
                        </p>
                      )}
                      ...
                      {m.body && (
                        <div
                          ...
                          style={{
                            ...
                            boxShadow: isMine ? "0 2px 6px rgba(173, 94, 59,0.25)" : "0 1px 3px rgba(0,0,0,0.05)",
                          }}
                        >
                          {m.body}
                        </div>
