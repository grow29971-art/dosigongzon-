...
export const metadata: Metadata = {
  ...
  description:
    "서울·부산·인천·대구·대전·광주·울산·세종·제주·경기 등 전국 광역시·도 길고양이 돌봄 현황. 내 지역 길집사와 함께 만드는 도시공존.",
    ...
    <div className="min-h-dvh pb-16" style={{ background: "#F7F4EE" }}>
      ...
      <section className="px-5 pt-4">
        ...
        <p className="text-[13px] text-text-sub mt-2 leading-relaxed">
          ...
          내 지역을 눌러 등록된 고양이와 길집사 활동을 확인하세요.
        </p>
      </section>
      ...
      <section className="px-5 mt-5">
        <h2 className="text-[13px] font-bold text-text-main mb-2.5 px-1">광역시·도</h2>
