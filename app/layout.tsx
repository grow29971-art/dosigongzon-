...
const SITE_DESCRIPTION =
  "우리 동네 길고양이 지도 · 돌봄다이어리 · TNR·중성화 정보 · 병원/약국 안내를 한 곳에서. 이웃과 함께 만드는 따뜻한 돌봄 커뮤니티, 도시공존.";
const SITE_KEYWORDS = [
  "길고양이", "길냥이", "길집사", "케어테이커", "TNR", "중성화",
...
export const viewport: Viewport = {
  ...
  maximumScale: 1,
  userScalable: false,
  themeColor: "#FFFFFF", // meta theme-color는 CSS 변수를 해석하지 못함 — --color-surface 실제 hex (순백)
  ...
  return (
    <html lang="ko">
      ...
      <body>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `if("serviceWorker"in navigator)navigator.serviceWorker.register("/sw.js");localStorage.removeItem("dosigongzon_dark");document.documentElement.classList.remove("dark")`,
          }}
        />
      </body>
    </html>
