      ...
      >
        ...
        <div
          style={{
            ...
            height: 420,
            borderRadius: "50%",
            background: "radial-gradient(circle, rgba(92,141,238,0.22) 0%, rgba(92,141,238,0) 70%)",
          }}
        />
        <div
          style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <div
              style={{
                ...
                fontSize: 38,
                boxShadow: "0 10px 30px rgba(92,141,238,0.3)",
              }}
            >
              🐾
            </div>
          ...
          {showLaunch && (
            <div
              style={{
                ...
                padding: "12px 22px",
                borderRadius: 999,
                background: "linear-gradient(135deg, #5C8DEE 0%, #E86B8C 100%)",
                color: "#FFFFFF",
                fontSize: 22,
                fontWeight: 900,
                boxShadow: "0 8px 24px rgba(92,141,238,0.40)",
              }}
            >
              🚀 정식 출시!
            </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14, marginTop: 50 }}>
          ...
          >
            ...
            <span style={{ color: "#5C8DEE" }}>함께 기록하고 지켜요.</span>
          </div>
          <p
            style={{
              fontSize: 26,
        ...
        >
          <StatCard emoji="🐾" value={s.cats} label="등록된 아이" color="#5C8DEE" />
  ...
  return (
    <div
      style={{
        ...
        flexDirection: "column",
        gap: 4,
        border: "2px solid rgba(92,141,238,0.20)",
      }}
    >
