    ...
    <div className="min-h-dvh flex flex-col items-center px-6 pt-20 pb-10" style={{ background: "#FBF8F3" }}>
      ...
      >
        <div
          ...
          style={{ width: 64, height: 64, background: "var(--color-primary-soft, rgba(17,17,17,0.1))" }}
          aria-hidden
        >
        ...
        {state.status === "valid" && (
          <>
            <p className="text-[15px] leading-relaxed mb-2" style={{ color: "#555555" }}>
        ...
        {state.status !== "valid" && (
          <>
            ...
            <Link
              ...
              style={{ background: "var(--color-surface-alt, #F2F2F2)", color: "#555555" }}
            >
              도시공존 둘러보기
            </Link>
          </>
