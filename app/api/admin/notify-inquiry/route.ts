  ...
  try {
    ...
    await resend.emails.send({
      ...
      html:
        ...
        `<p style="margin:16px 0 0"><a href="${adminUrl}" style="display:inline-block;padding:8px 14px;background:#5C8DEE;color:#fff;text-decoration:none;border-radius:6px;font-weight:bold">관리자 페이지 열기</a></p>` +
        `</div>`,
    });
