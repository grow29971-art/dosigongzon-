...
const OFFLINE_RESPONSES: { keywords: string[]; answer: string }[] = [
  ...
  { keywords: ["학대", "때리", "괴롭", "파손", "훼손"], answer: "동물학대를 목격하셨다면 즉시 112에 신고해주세요. 동물보호법 제10조에 따라 3년 이하 징역 또는 3,000만원 이하 벌금에 처할 수 있어요. 현장 증거를 확보하시면 큰 도움이 됩니다. {name}의 용기가 동물을 지킵니다!" },
...
- 돌봄다이어리: 고양이별로 밥/물/건강체크/병원 방문 등 돌봄 기록 가능. 지도에서 고양이 탭.
