  ...
  return (
    <div className="min-h-dvh pb-16" style={{ background: "#FFFFFF" }}>
      ...
      <section className="px-5 pt-8 text-center">
        <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full mb-4" style={{ background: "rgba(17, 17, 17,0.12)", color: "var(--color-primary-dark)" }}>
          <Sparkles size={12} />
      ...
      <section className="px-5 mt-7">
        ...
        <Link
          ...
          style={{ background: "#FFFFFF", color: "var(--color-primary-dark)", border: "1px solid rgba(17, 17, 17,0.25)" }}
        >
          운영 이야기 보기
        </Link>
      </section>
