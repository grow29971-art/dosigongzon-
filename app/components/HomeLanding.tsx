  ...
  return (
    <div className="pb-6">
      ...
      <section className="px-5 pt-6 pb-8" style={{ background: "linear-gradient(180deg, #FFF9F2 0%, #F7F4EE 100%)" }}>
        ...
        <div className="flex gap-2 mt-5">
          <Link
            ...
            style={{
              ...
              boxShadow: "0 8px 22px rgba(25, 31, 40,0.38), 0 2px 6px rgba(168,104,74,0.22)",
            }}
          >
            <PawPrint size={15} />
          ...
          <Link
            ...
            style={{
              background: "rgba(25, 31, 40,0.09)",
              color: "var(--color-primary)",
              border: "1.5px solid rgba(25, 31, 40,0.45)",
            }}
          >
            <Sparkles size={14} />
        ...
        <p className="mt-2 text-center text-[11px] font-bold" style={{ color: "rgba(25, 31, 40,0.7)" }}>
          10초 가입 · 광고 없는 무료 운영
        </p>
      ...
      <section className="px-5 mt-8 cv-auto">
        ...
        >
          <TrustInline emoji="🐾" value={data.catCount} label="등록" color="#191F28" />
      ...
      <section className="px-5 mt-8 cv-auto">
        ...
        <div className="grid grid-cols-2 gap-2">
          <TechCard
            icon={<MapPin size={16} color="#191F28" />}
            iconBg="#191F2815"
            title="전국 구·동 자체 매핑"
            sub="구·동 단위 좌표 직접 정리"
          />
