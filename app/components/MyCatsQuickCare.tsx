    ...
    >
      <div className="flex items-center justify-between mb-2.5">
        <div className="min-w-0">
          <p className="text-[10px] font-extrabold tracking-[0.15em]" style={{ color: "#8B6FE0" }}>내 아이 오늘 한 끼</p>
          <p className="text-[12px] text-text-sub mt-0.5">탭 한 번이면 끝 — 메모·사진 없이도 OK</p>
        </div>
        <p className="text-[11.5px] font-extrabold shrink-0" style={{ color: "#8B6FE0" }}>
