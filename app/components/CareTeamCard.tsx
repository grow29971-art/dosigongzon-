          ...
          {careTeamSections().map((section) => {
            ...
            return (
              <li key={section.key}>
                {isCurrent ? (
                  <div
                    className="flex items-center justify-between rounded-xl bg-[#FFFFFF] px-3 py-2.5"
                    aria-current="page"
                  >
                    {label}
                  ...
                  <Link
                    href={section.href}
                    className="flex items-center justify-between rounded-xl bg-[#FFFFFF] px-3 py-2.5 press"
                  >
                    {label}
