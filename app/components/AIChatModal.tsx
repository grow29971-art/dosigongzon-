        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto px-5 py-4 space-y-3">
          ...
          {loading && (
            <div className="flex justify-start">
              ...
              >
                <span className="w-2 h-2 rounded-full animate-bounce" style={{ backgroundColor: "rgba(173, 94, 59,0.4)", animationDelay: "0ms" }} />
                <span className="w-2 h-2 rounded-full animate-bounce" style={{ backgroundColor: "rgba(173, 94, 59,0.4)", animationDelay: "150ms" }} />
                <span className="w-2 h-2 rounded-full animate-bounce" style={{ backgroundColor: "rgba(173, 94, 59,0.4)", animationDelay: "300ms" }} />
              </div>
            </div>
          )}
        </div>
