      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow: "0 12px 28px rgba(0,0,0,0.25), 0 2px 6px rgba(49,130,246,0.2)",
            maxWidth: 240,
          }}
        >
          <button
          ...
          <div className="flex items-center gap-1.5 mb-1 pr-6">
            ...
            <p className="text-[12px] font-extrabold" style={{ color: "var(--color-primary)" }}>
              첫 고양이 등록하기
            </p>
          </div>
        ...
        >
          ...
          <div
            ...
            style={{ background: "rgba(49,130,246,0.35)" }}
          />
          <ArrowDownRight
            size={32}
            color="#fff"
