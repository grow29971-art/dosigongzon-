        ...
        >
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              ...
              style={{
                background: copiedId === b.id ? "var(--color-sage-soft)" : "rgba(17, 17, 17,0.10)",
