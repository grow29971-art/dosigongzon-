      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #E88D5A 0%, #4C82BC 100%)",
              boxShadow: "0 8px 24px rgba(76,130,188,0.45)",
            }}
          >
        ...
        <div className="px-6 pt-5 pb-6">
          <p className="text-[13px] leading-relaxed text-text-main mb-4">
            ...
            {" "}초기 멤버에게만 영구 한정 타이틀
            {" "}<b style={{ color: "#3E6FA8" }}>🌟 초기 200</b>이 자동 부여됐어요.
          </p>
          ...
          >
            <p className="font-extrabold mb-1" style={{ color: "#3E6FA8" }}>
              💎 이런 의미예요
            </p>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              style={{ color: "#3E6FA8", border: "1.5px solid rgba(76,130,188,0.30)" }}
            >
              나중에
            </button>
          </div>
