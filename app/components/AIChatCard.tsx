      ...
      >
        <div className="flex items-center gap-3.5 mb-3.5">
          <div
            ...
            style={{
              ...
              boxShadow: "0 5px 12px rgba(17, 17, 17,0.35), inset 0 1px 0 rgba(255,255,255,0.4), inset 0 -2px 4px rgba(0,0,0,0.08)",
            }}
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            style={{
              background: "var(--color-primary)",
              boxShadow: "0 4px 10px rgba(17, 17, 17,0.35), inset 0 1px 0 rgba(255,255,255,0.3)",
            }}
          >
