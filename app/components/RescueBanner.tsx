    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[11px] font-extrabold tracking-[0.12em] text-[#B84545] dark:text-[#FF9090]">
            URGENT · 지금 돌봄 필요
          </p>
          <p className="text-[15px] font-extrabold tracking-tight leading-tight mt-0.5 text-[#3A1F1F] dark:text-[#FFE0E0]">
