      ...
      {user && myRegions.length === 0 && activity && activity.catCount > 0 && (
        <Link
          ...
          style={{
            ...
            borderRadius: 20,
            boxShadow: "0 8px 24px rgba(25, 31, 40,0.28)",
          }}
        >
                ...
                <div className="mt-3 space-y-1.5">
                  ...
                  {SHOW_WEATHER_SHOP_BRIDGE && bridge && (
                    <Link
                      ...
                      style={{ background: "var(--color-primary-softer)", border: "1px solid rgba(25, 31, 40,0.15)" }}
                    >
      ...
      */}
        ...
        <div className="mb-5">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2 px-1">
              ...
              {primaryRegion && (
                <span className="text-[10px] font-bold px-2 py-0.5 rounded-lg" style={{ background: "rgba(25, 31, 40,0.12)", color: "var(--color-primary)" }}>
                  📍 {primaryRegion.name}
                </span>
              )}
            </div>
            ...
            >
              <div
                ...
                style={{
                  ...
                  borderRadius: 18,
                  border: "1px dashed rgba(25, 31, 40,0.3)",
                }}
              >
                <div
                ...
                >
                  <MapPin size={18} color="#191F28" strokeWidth={2} />
                </div>
                <div className="flex-1 min-w-0">
                      ...
                      {neighborhoodPosts.map((p) => (
                        ...
                        >
                          <span
                            ...
                            style={{ backgroundColor: "rgba(25, 31, 40,0.12)", color: "var(--color-primary)" }}
                          >
                            {p.region}
                          </span>
      ...
      <Link
        ...
        style={{
          ...
          borderRadius: 22,
          boxShadow: "0 4px 16px rgba(25, 31, 40,0.10), 0 1px 3px rgba(0,0,0,0.03)",
      ...
      >
        <div className="mx-auto max-w-lg">
          <button
            ...
            style={{
              background: "linear-gradient(135deg, var(--color-primary) 0%, var(--color-primary-dark) 100%)",
              boxShadow: "0 6px 20px rgba(25, 31, 40,0.35)",
            }}
          >
            🍚 돌봄 기록하기
          </button>
