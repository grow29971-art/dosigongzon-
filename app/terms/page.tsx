      ...
      <div className="space-y-6 text-[13px] text-text-sub leading-relaxed">
        ...
        <section>
          ...
          <ol className="list-decimal pl-5 space-y-1">
            ...
            <li>이용자 본인의 위치(GPS)는 <b>회원 단말 안에서만 이용</b>되며, 자세한 사항은 제9조의5(단말 위치의 이용)를 따릅니다. 지도 위치 지정은 이용자가 지도에서 직접 선택하거나 활동 지역명(동·구)을 입력하는 방식도 함께 제공됩니다.</li>
          </ol>
        </section>
        ...
        <section>
          ...
          <ol className="list-decimal pl-5 space-y-1">
            ...
            <li>서버로 전달되는 값은 개인의 위치를 식별할 수 없는 수준으로 단말에서 변환된 정보에 한합니다: 날씨 조회는 <b>약 5km 격자로 뭉갠 좌표</b>, 활동 지역은 <b>행정동 중심 좌표·지역명</b>, 고양이 등록 좌표는 회원이 지도에서 직접 선택한 사물(고양이) 위치에 <b>제9조 제2항의 오프셋을 단말에서 적용한 값</b>입니다.</li>
            <li>지도 표시·주소 변환은 카카오(위치기반서비스사업자)의 지도 SDK가 회원 단말에서 직접 처리하며, &lsquo;내 위치 보내기&rsquo;는 단말의 문자·공유 기능으로 회원이 지정한 상대에게 직접 전송되어 <b>운영자를 경유하지 않습니다.</b></li>
            <li>회원은 언제든지 단말의 위치 권한을 해제하여 위치 이용을 중단할 수 있으며, 위치 권한 없이도 지도에서 직접 선택하거나 지역명(동·구)을 입력하는 방식으로 서비스를 이용할 수 있습니다.</li>
            <li>서비스는 만 14세 미만의 가입을 제한합니다(제5조).</li>
            <li>위치 관련 문의: 앱 내 1:1 문의 또는 고객센터 이메일.</li>
          </ol>
        </section>
          ...
          <ol className="list-decimal pl-5 space-y-1">
            <li>회원은 다음 행위를 하여서는 안 됩니다.
              <ul className="list-disc pl-4 mt-1 space-y-0.5">
                ...
                <li>서비스에 공개된 정보(닉네임·활동 지역·돌봄 기록·사진 등)를 이용하여 <b>다른 회원의 신원을 특정하거나, 위협·보복·괴롭힘·스토킹을 목적으로 정보를 수집·이용·유포하는 행위</b></li>
        ...
        <div
          ...
          style={{ backgroundColor: "var(--color-surface-alt)", border: "1px solid var(--color-divider)" }}
        >
          ...
          <p className="text-[11px] text-text-light mt-1">제3조 (개정) 2026년 8월 2일자로 제9조의5 개정 — 단말 위치는 기기 안에서만 이용하고 개인위치정보를 서버로 전송·수집·저장하지 않는 방식으로 변경.</p>
        </div>
      </div>
    </div>
  );
