      ...
      <div className="space-y-6 text-[13px] text-text-sub leading-relaxed">
        ...
        <section>
          ...
          <ol className="list-decimal pl-5 space-y-1">
            ...
            <li>이용자 본인의 위치(GPS) 측위는 <b>회원이 해당 기능 이용 시 동의한 경우에 한하여</b> 사용되며, 자세한 사항은 제9조의5(개인위치정보의 처리)를 따릅니다. 지도 위치 지정은 이용자가 지도에서 직접 선택하거나 활동 지역명(동·구)을 입력하는 방식도 함께 제공됩니다.</li>
          </ol>
        </section>

        <section>
          <h2 className="text-[14px] font-bold text-text-main mb-2">제9조의5 (개인위치정보의 처리 · 위치기반서비스)</h2>
          <ol className="list-decimal pl-5 space-y-1">
            <li>서비스는 「위치정보의 보호 및 이용 등에 관한 법률」에 따라 위치기반서비스사업을 운영하며, 회원이 관련 기능 이용 시 <b>단말의 위치 접근 권한을 허용하여 동의한 경우에 한하여</b> 개인위치정보를 처리합니다.</li>
            <li>수집·이용하는 개인위치정보 항목: <b>이용자 단말의 위치 좌표(위도·경도)</b>.</li>
            <li>이용 목적: (가) 지도 화면을 이용자 인근으로 자동 이동, (나) &lsquo;내 위치로 이동&rsquo; 기능, (다) 고양이 등록 시 활동 지역(동·구) 자동 감지 보조, (라) 날씨 정보의 지역 맞춤 제공.</li>
            <li>서비스는 이용자의 <b>실시간 단말 위치를 별도로 저장하지 않으며</b>, 위 목적 달성 즉시 이용 후 파기합니다. 다만 고양이 등록 시 이용자가 직접 확인·선택하여 저장되는 좌표에는 제9조 제2항의 퍼징(최대 약 ±944m)이 적용됩니다.</li>
            <li>제3자 제공: 지도 표시를 위해 카카오맵(지도 SDK)에, 날씨 조회를 위해 날씨정보 제공자에게 좌표가 전달될 수 있으며, 그 외 제3자에게 제공하지 않습니다.</li>
            <li><b>개인위치정보주체의 권리</b>: 회원은 언제든지 개인위치정보의 수집·이용·제공에 대한 동의의 전부 또는 일부를 철회하거나(단말의 위치 권한 해제 포함), 그 일시적 중지를 요구할 수 있으며, 자신에 대한 위치정보 이용·제공사실 확인자료의 열람·고지를 요구할 수 있습니다. 동의 철회 시 서비스는 수집된 개인위치정보 및 확인자료를 지체 없이 파기합니다.</li>
            <li>서비스는 만 14세 미만의 가입을 제한하므로(제5조) 원칙적으로 아동의 개인위치정보를 처리하지 않습니다.</li>
            <li>위치정보 이용·제공사실 확인자료는 같은 법 제16조에 따라 자동 기록·보존됩니다.</li>
            <li><b>위치정보관리책임자</b>: 서비스 운영자(문의: 앱 내 1:1 문의 또는 고객센터 이메일).</li>
          </ol>
        </section>
