...
const STEPS = [
  { step: 1, title: "준비물 확인", color: "#14B8A6", items: ["포획틀 (동물보호센터 대여 가능)", "참치/습식사료 (미끼용)", "두꺼운 장갑 + 큰 수건", "이동장 (캐리어)"] },
  { step: 2, title: "포획틀 설치", color: "#3B82F6", items: ["고양이가 자주 다니는 경로에 설치", "포획틀 아래 신문지 깔기", "입구 반대편에 미끼 배치", "밝은 조명은 피하기 (어두운 곳 선호)"] },
  { step: 3, title: "대기", color: "#8B5CF6", items: ["포획틀에서 떨어져 관찰 (최소 10m)", "30분~수시간 소요될 수 있음", "소음 최소화, 인내심 필요", "여러 마리인 경우 한 마리씩 진행"] },
  { step: 4, title: "주의사항", color: "#EF4444", items: ["포획 후 수건으로 틀을 덮어 안정시키기", "절대 맨손으로 만지지 않기", "TNR 고양이(이어팁)는 재포획 불필요", "포획 후 최대한 빨리 병원/보호소 이동"] },
];
