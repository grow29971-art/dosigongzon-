...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "네, 책임감이 중요해요. 길고양이는 급식 패턴에 몸을 맞추기 때문에 갑자기 끊으면 다른 먹이를 찾지 못해 아사 위험이 있어요. 이사·여행 등으로 어려우면 동네 케어테이커에게 인수인계를 부탁하거나 도시공존 커뮤니티에서 이웃 구하세요.",
      },
    },
    {
      "@type": "Question",
        ...
        <div className="space-y-2">
          {STEPS.map(({ icon: Icon, title, desc }) => (
            ...
            >
              ...
              >
                <Icon size={18} style={{ color: "#5C8DEE" }} />
              </div>
              <div>
