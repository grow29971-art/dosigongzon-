        ...
        <div className="flex items-end justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              style={{ boxShadow: "0 6px 14px rgba(76,130,188,0.35)" }}
              aria-label="새 병원 추가"
            >
      ...
      {editingId && (
        <div
          ...
          style={{
            background: "#FFFFFF",
            borderRadius: 20,
            boxShadow: "0 8px 24px rgba(76,130,188,0.14), 0 1px 3px rgba(0,0,0,0.03)",
                      ...
                      {d.hospitals.map((h) => (
                        <div
                          ...
                          style={{
                            ...
                            borderRadius: 14,
                            boxShadow: h.pinned
                              ? "0 4px 14px rgba(76,130,188,0.12), 0 1px 2px rgba(0,0,0,0.02)"
                          ...
                          <div className="flex items-start justify-between gap-2 mb-1">
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-1.5 mb-0.5">
                                {h.pinned && (
                                  <Pin size={10} style={{ color: "#4C82BC" }} />
                                )}
                            ...
                            <div className="flex gap-1 shrink-0">
                              <button
                                ...
                                aria-label="수정"
                              >
                                <Pencil size={12} style={{ color: "#4C82BC" }} strokeWidth={2.3} />
                              </button>
                              <button
