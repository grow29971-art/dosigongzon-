...
const EMPTY: PharmacyGuideInput = {
  name: "", brand: null, category: "", color: "#3182F6",
    ...
    <div className="px-4 pt-14 pb-24">
      ...
      <div className="mb-5">
        ...
        <div className="flex items-end justify-between">
          ...
          <button onClick={handleCreate} className="w-11 h-11 rounded-full bg-primary flex items-center justify-center active:scale-95 transition-transform" style={{ boxShadow: "0 6px 14px rgba(49,130,246,0.35)" }}>
      ...
      {/* 편집 폼 */}
      {editingId && (
        <div className="mb-5 p-4" style={{ background: "#FFFFFF", borderRadius: 20, boxShadow: "0 8px 24px rgba(49,130,246,0.14)", border: "1.5px solid rgba(49,130,246,0.2)" }}>
        ...
        {items.length === 0 ? (
          ...
          <div key={item.id} className="p-4" style={{ background: "#FFFFFF", borderRadius: 18, boxShadow: "0 4px 14px rgba(0,0,0,0.04)", border: "1px solid rgba(0,0,0,0.04)" }}>
            ...
            <div className="flex gap-1.5 mt-3 pt-3 border-t border-divider">
              <button onClick={() => handleEdit(item)} className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-lg text-[12px] font-bold" style={{ backgroundColor: "#EEE8E0", color: "#3182F6" }}>
                <Pencil size={12} /> 수정
              </button>
