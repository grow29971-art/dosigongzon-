...
export default function AdminPushPage() {
  ...
  return (
    <div className="px-5 pt-14 pb-8 max-w-lg mx-auto">
      ...
      {/* 미리보기 */}
      <div className="rounded-2xl p-4 mb-5" style={{ backgroundColor: "#F7F7F7", border: "1px solid rgba(17, 17, 17,0.15)" }}>
      ...
      <div className="space-y-4">
        ...
        <div className="pt-2">
          ...
          <button
            ...
            style={{ color: "var(--color-primary-dark)", border: "1.5px solid rgba(17, 17, 17,0.35)" }}
          >
            {scheduling ? (
              <>
            ...
            <div className="space-y-2">
              {scheduled.map((s) => (
                <div
                  ...
                  style={{ backgroundColor: "#F7F7F7", border: "1px solid rgba(17, 17, 17,0.15)" }}
                >
