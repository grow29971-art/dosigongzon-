        ...
        <div className="px-4 space-y-5">
          ...
          <Section icon={<TrendingUp size={14} />} label="누적">
            <div className="grid grid-cols-2 gap-2.5">
              ...
              <StatCard icon={<CatIcon size={16} />} label="등록 고양이" value={data.totalCats} delta={data.newCatsToday} accent="#5C8DEE" />
                ...
                {data.topCats.map((c, i) => (
                  ...
                  >
                    <div className="flex items-center gap-2 min-w-0">
                      <span className="text-[11px] font-extrabold w-4 shrink-0" style={{ color: "#5C8DEE" }}>
                        {i + 1}
                      </span>
