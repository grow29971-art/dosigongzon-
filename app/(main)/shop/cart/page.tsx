    ...
    <div className="pb-32">
      ...
      {loading ? (
        <div className="px-4 mt-4 space-y-3">
          {[0, 1].map((i) => (
            <div key={i} className="rounded-2xl animate-pulse" style={{ height: 96, background: "#EEF1F6" }} />
          ))}
        </div>
      ) : items.length === 0 ? (
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-1.5 flex items-center gap-2 px-2 py-1 rounded-xl w-fit" style={{ background: "#F4F7FC" }}>
