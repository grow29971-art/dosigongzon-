                      ...
                      <div className={isLast ? "flex items-center" : "flex items-center w-full"}>
                        <div
                          ...
                          style={{
                            ...
                            boxShadow: reached ? "0 2px 6px rgba(17, 17, 17,0.35)" : "none",
                          }}
                        >
            ...
            {order.tracking_number && (
              <div className="mt-2.5">
                ...
                <a
                  ...
                  style={{ background: "var(--color-primary-soft)", color: "var(--color-primary-dark)", border: "1px solid rgba(17,17,17,0.18)" }}
                >
                ...
                <div className="space-y-1.5 mb-3">
                  {USER_REASONS.map((code) => (
                    <button
                      ...
                      style={{
                        background: reason === code ? "rgba(17,17,17,0.08)" : "var(--color-warm-white)",
                        color: reason === code ? "var(--color-primary)" : "var(--color-text-sub)",
                        border: reason === code ? "1.5px solid rgba(17,17,17,0.4)" : "1px solid var(--color-divider)",
                      }}
                    >
