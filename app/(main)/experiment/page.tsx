  ...
  return (
    <div className="px-5 pt-6 pb-10 max-w-lg mx-auto">
      ...
      <header className="mb-5">
        ...
        <h1 className="text-[24px] font-bold mt-0.5" style={{ color: "var(--color-text, #111111)" }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  color: done ? "var(--color-primary)" : "#555555",
...
function Banner({ text }: { text: string }) {
  return (
    <div
      ...
      style={{ background: "var(--color-primary-soft, rgba(17,17,17,0.1))", color: "var(--color-primary)" }}
    >
      {text}
    </div>
  );
