      ...
      {loading ? (
        ...
        <>
          ...
          {invitations.length > 0 && (
            <section className="px-5 mt-6">
              <div className="flex items-center gap-2 mb-3">
                <Mail size={14} style={{ color: "#5C8DEE" }} />
                <h2 className="text-[14px] font-extrabold text-text-main">받은 초대</h2>
                <span className="text-[11px] font-bold px-2 py-0.5 rounded-full text-white" style={{ background: "#5C8DEE" }}>
                  {invitations.length}
                </span>
              </div>
          ...
          {myCircleId && (
            <section className="px-5 mt-6">
              <div className="flex items-center gap-2 mb-3">
                <MessageCircle size={14} style={{ color: "#5C8DEE" }} />
              ...
              <Link
                ...
                style={{
                  ...
                  boxShadow: "0 2px 10px rgba(92,141,238,0.10)",
                }}
              >
