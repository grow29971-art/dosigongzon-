...
let rootUrl = URL(string: "https://dosigongzon.com")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["dosigongzon.com"]
...
let adaptiveUIStyle = false    // disabled: dark landing page caused black screen on launch
